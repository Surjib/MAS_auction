package Project.ProducerBehaviour;

import Project.JsonParser;
import Project.Model.CurrentProduserData;
...
public class SendPrice extends Behaviour {
    ...
    public void action() {
        ...
        if (msg != null) {
            ...
            DistributorData distributorData = JsonParser.ToJson(msg.getContent(), DistributorData.class);
